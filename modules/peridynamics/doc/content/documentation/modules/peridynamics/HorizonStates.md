...
More discussion about $\textit{horizon}$ can be found in [citet:Bobaru2012horizon].
...
More information about $\textit{states}$ can be found in [citet:Silling2007states].
