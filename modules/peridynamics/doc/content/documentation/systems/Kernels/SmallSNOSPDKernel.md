...
!syntax description /Kernels/SmallSNOSPDKernel

## Description

The Kernel `SmallSNOSPDKernel` calculates the residual and jacobian entries of the force density integral for self-stabilized non-ordinary state-based models under infinitesimal strain assumptions.
