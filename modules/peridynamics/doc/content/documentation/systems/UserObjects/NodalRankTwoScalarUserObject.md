# NodalRankTwoScalarUserObject

!syntax description /UserObjects/NodalRankTwoScalarUserObject

## Description

The UserObject `NodalRankTwoScalarUserObject` is used to compute the values of equivalent scalar quantities of a rank two tensor at each material point for correspondence material model. The scalar variable should be defined as aux variable, but its value is computed using UserObject rather than AuxKernel.
