...
#include "GeneralizedPlaneStrainSNOSPDUserObject.h"
#include "RankTwoTensor.h"

registerMooseObject("PeridynamicsApp", GeneralizedPlaneStrainSNOSPDUserObject);

template <>
InputParameters
validParams<GeneralizedPlaneStrainSNOSPDUserObject>()
{
  InputParameters params = validParams<GeneralizedPlaneStrainPDUserObject>();
...
GeneralizedPlaneStrainSNOSPDUserObject::GeneralizedPlaneStrainSNOSPDUserObject(
    const InputParameters & parameters)
  : GeneralizedPlaneStrainPDUserObject(parameters),
    _stress(getMaterialProperty<RankTwoTensor>("stress"))
{
}

void
GeneralizedPlaneStrainSNOSPDUserObject::execute()
{
