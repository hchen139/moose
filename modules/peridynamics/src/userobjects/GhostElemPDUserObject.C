...
#include "GhostElemPDUserObject.h"
#include "PeridynamicMesh.h"

registerMooseObject("PeridynamicsApp", GhostElemPDUserObject);

template <>
InputParameters
validParams<GhostElemPDUserObject>()
{
...
GhostElemPDUserObject::GhostElemPDUserObject(const InputParameters & parameters)
...
void
GhostElemPDUserObject::meshChanged()
{
  ghostElements();
}

void
GhostElemPDUserObject::ghostElements()
{
