...
#include "GeneralizedPlaneStrainOSPDUserObject.h"
#include "RankFourTensor.h"
#include "Function.h"

registerMooseObject("PeridynamicsApp", GeneralizedPlaneStrainOSPDUserObject);

template <>
InputParameters
validParams<GeneralizedPlaneStrainOSPDUserObject>()
{
...
GeneralizedPlaneStrainOSPDUserObject::GeneralizedPlaneStrainOSPDUserObject(
...
void
GeneralizedPlaneStrainOSPDUserObject::execute()
{
