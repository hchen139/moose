...
template <>
InputParameters
validParams<BPDSmallStrainMaterial>()
{
...
BPDSmallStrainMaterial::BPDSmallStrainMaterial(const InputParameters & parameters)
  : PDParametricMaterial(parameters)
{
}

void
BPDSmallStrainMaterial::computeBondForce()
{
