...
registerMooseObject("PeridynamicsApp", CorrespondenceSmallStrain);

template <>
InputParameters
validParams<CorrespondenceSmallStrain>()
{
...
CorrespondenceSmallStrain::CorrespondenceSmallStrain(const InputParameters & parameters)
  : CorrespondenceMaterial(parameters)
{
}

void
CorrespondenceSmallStrain::computeQpStrain()
{
...
void
CorrespondenceSmallStrain::computeQpTotalStrain()
{
