...
template <>
InputParameters
validParams<PDParametricMaterial>()
{
...
PDParametricMaterial::PDParametricMaterial(const InputParameters & parameters)
  : PDMechanicMaterial(parameters),
    ...
    _elastic_stretch(declareProperty<Real>("elastic_stretch")),
...
void
PDParametricMaterial::computeProperties()
{
...
void
PDParametricMaterial::computeNodalTemperature()
{
  if (_has_temp)
  {
...
void
PDParametricMaterial::computeQpProperties()
{
...
void
PDParametricMaterial::computeBondStretch()
{
  ...
  _elastic_stretch[_qp] = _mechanical_stretch[_qp];
}
