...
template <>
InputParameters
validParams<OSPDSmallStrainMaterial>()
{
...
OSPDSmallStrainMaterial::OSPDSmallStrainMaterial(const InputParameters & parameters)
...
void
OSPDSmallStrainMaterial::computeBondForce()
{
