...
registerMooseObject("PeridynamicsApp", CorrespondenceFiniteStrain);

MooseEnum
CorrespondenceFiniteStrain::decompositionType()
{
...
template <>
InputParameters
validParams<CorrespondenceFiniteStrain>()
{
  InputParameters params = validParams<CorrespondenceMaterial>();
...
CorrespondenceFiniteStrain::CorrespondenceFiniteStrain(const InputParameters & parameters)
  : CorrespondenceMaterial(parameters),
...
void
CorrespondenceFiniteStrain::computeQpStrain()
{
...
void
CorrespondenceFiniteStrain::computeQpFhat()
{
...
void
CorrespondenceFiniteStrain::computeQpStrainRotationIncrements(
    RankTwoTensor & total_strain_increment, RankTwoTensor & rotation_increment)
{
  switch (_decomposition_method)
  {
    ...
    default:
      mooseError("CorrespondenceFiniteStrain Error: Invalid decomposition type! Please specify : "
                 "TaylorExpansion or "
                 "EigenSolution.");
  }
}
...
void
CorrespondenceFiniteStrain::subtractEigenstrainIncrementFromStrain(RankTwoTensor & strain)
{
