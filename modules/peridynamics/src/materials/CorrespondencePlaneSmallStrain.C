...
#include "CorrespondencePlaneSmallStrain.h"

registerMooseObject("PeridynamicsApp", CorrespondencePlaneSmallStrain);

template <>
InputParameters
validParams<CorrespondencePlaneSmallStrain>()
{
...
CorrespondencePlaneSmallStrain::CorrespondencePlaneSmallStrain(const InputParameters & parameters)
...
void
CorrespondencePlaneSmallStrain::computeQpTotalStrain()
{
...
Real
CorrespondencePlaneSmallStrain::computeOutOfPlaneStrain()
{
