...
validParams<GeneralizedPlaneStrainPD>()
{
  ...
  params.addClassDescription("Class for claculating residual and diagonal jacobian for ordinary "
                             "state-based peridynamic generalized plane strain formulation");
  params.addRequiredParam<UserObjectName>(
      "generalized_plane_strain_uo", "User object name of the GeneralizedPlaneStrainPDUserObject");
...
GeneralizedPlaneStrainPD::GeneralizedPlaneStrainPD(const InputParameters & parameters)
  : ScalarKernel(parameters),
    _gpsuo(getUserObject<GeneralizedPlaneStrainPDUserObject>("generalized_plane_strain_uo"))
{
}
