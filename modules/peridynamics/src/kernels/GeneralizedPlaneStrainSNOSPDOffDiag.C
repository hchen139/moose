...
#include "GeneralizedPlaneStrainSNOSPDOffDiag.h"
#include "MooseVariableScalar.h"

registerMooseObject("PeridynamicsApp", GeneralizedPlaneStrainSNOSPDOffDiag);

template <>
InputParameters
validParams<GeneralizedPlaneStrainSNOSPDOffDiag>()
{
  InputParameters params = validParams<SNOSPDKernelBase>();
  params.addClassDescription("Class for calculating off-diagonal jacobian corresponding to "
                             "coupling with scalar_out_of_plane_strain for "
                             "generalized plane strain in SNOSPD formulation");
...
GeneralizedPlaneStrainSNOSPDOffDiag::GeneralizedPlaneStrainSNOSPDOffDiag(
    const InputParameters & parameters)
  : SNOSPDKernelBase(parameters),
...
void
GeneralizedPlaneStrainSNOSPDOffDiag::computeOffDiagJacobianScalar(unsigned int jvar_num)
{
...
void
GeneralizedPlaneStrainSNOSPDOffDiag::computeDispPartialOffDiagJacobianScalar(unsigned int component,
...
void
GeneralizedPlaneStrainSNOSPDOffDiag::computeDispFullOffDiagJacobianScalar(unsigned int component,
                                                                          unsigned int jvar_num)
{
  // LOCAL contribution
...
void
GeneralizedPlaneStrainSNOSPDOffDiag::computeTempOffDiagJacobianScalar(unsigned int jvar_num)
{
  ...
  /*
    one-way coupling between the scalar_out_of_plane_strain and temperature.
    fill in the row corresponding to the scalar_out_of_plane_strain
  */
