...
#include "FNOSPDKernel.h"
#include "PeridynamicMesh.h"

registerMooseObject("PeridynamicsApp", FNOSPDKernel);

template <>
InputParameters
validParams<FNOSPDKernel>()
{
...
FNOSPDKernel::FNOSPDKernel(const InputParameters & parameters)
...
void
FNOSPDKernel::computeLocalResidual()
{
...
void
FNOSPDKernel::computeLocalJacobian()
{
...
void
FNOSPDKernel::computeNonlocalJacobian()
{
...
void
FNOSPDKernel::computeLocalOffDiagJacobian(unsigned int coupled_component)
{
  _local_ke.zero();
...
void
FNOSPDKernel::computePDNonlocalOffDiagJacobian(unsigned int jvar_num,
...
RankTwoTensor
FNOSPDKernel::computeDSDU(unsigned int component, unsigned int nd)
{
