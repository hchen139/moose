...
#include "FiniteSNOSPDKernel.h"

registerMooseObject("PeridynamicsApp", FiniteSNOSPDKernel);

template <>
InputParameters
validParams<FiniteSNOSPDKernel>()
{
...
FiniteSNOSPDKernel::FiniteSNOSPDKernel(const InputParameters & parameters)
...
void
FiniteSNOSPDKernel::computeLocalResidual()
{
  ...
  // CorrespondenceFiniteStrain material class.
...
void
FiniteSNOSPDKernel::computeLocalJacobian()
{
...
void
FiniteSNOSPDKernel::computeNonlocalJacobian()
{
...
void
FiniteSNOSPDKernel::computeLocalOffDiagJacobian(unsigned int coupled_component)
{
  _local_ke.zero();
...
void
FiniteSNOSPDKernel::computePDNonlocalOffDiagJacobian(unsigned int jvar_num,
...
RankTwoTensor
FiniteSNOSPDKernel::computeDSDU(unsigned int component, unsigned int nd)
{
...
RankFourTensor
FiniteSNOSPDKernel::computeDSDFhat(unsigned int nd)
{
...
Real
FiniteSNOSPDKernel::computeDJDU(unsigned int component, unsigned int nd)
{
...
RankTwoTensor
FiniteSNOSPDKernel::computeDinvFTDU(unsigned int component, unsigned int nd)
{
