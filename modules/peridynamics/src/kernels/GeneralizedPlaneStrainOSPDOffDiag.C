...
#include "GeneralizedPlaneStrainOSPDOffDiag.h"
#include "MooseVariableScalar.h"

registerMooseObject("PeridynamicsApp", GeneralizedPlaneStrainOSPDOffDiag);

template <>
InputParameters
validParams<GeneralizedPlaneStrainOSPDOffDiag>()
{
  ...
  params.addClassDescription("Class for calculating off-diagonal jacobian corresponding to "
                             ...
                             "generalized plane strain in OSPD formulation");
...
GeneralizedPlaneStrainOSPDOffDiag::GeneralizedPlaneStrainOSPDOffDiag(
...
void
GeneralizedPlaneStrainOSPDOffDiag::computeOffDiagJacobianScalar(unsigned int jvar_num)
{
...
void
GeneralizedPlaneStrainOSPDOffDiag::computeDispFullOffDiagJacobianScalar(unsigned int component,
...
void
GeneralizedPlaneStrainOSPDOffDiag::computeDispPartialOffDiagJacobianScalar(unsigned int component,
                                                                           unsigned int jvar_num)
{
  DenseMatrix<Number> & ken = _assembly.jacobianBlock(_var.number(), jvar_num);
  DenseMatrix<Number> & kne = _assembly.jacobianBlock(jvar_num, _var.number());
...
void
GeneralizedPlaneStrainOSPDOffDiag::computeTempOffDiagJacobianScalar(unsigned int jvar_num)
{
  // off-diagonal jacobian entries on the row
