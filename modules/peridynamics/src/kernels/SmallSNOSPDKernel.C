...
#include "SmallSNOSPDKernel.h"

registerMooseObject("PeridynamicsApp", SmallSNOSPDKernel);

template <>
InputParameters
validParams<SmallSNOSPDKernel>()
{
...
SmallSNOSPDKernel::SmallSNOSPDKernel(const InputParameters & parameters)
  : SNOSPDKernelBase(parameters), _component(getParam<unsigned int>("component"))
{
}

void
SmallSNOSPDKernel::computeLocalResidual()
{
  ...
  // Cauchy stress is calculated as Sigma = C * E in the CorrespondenceSmallStrain material class.
...
void
SmallSNOSPDKernel::computeLocalJacobian()
{
...
void
SmallSNOSPDKernel::computeNonlocalJacobian()
{
...
void
SmallSNOSPDKernel::computeLocalOffDiagJacobian(unsigned int coupled_component)
{
  _local_ke.zero();
...
void
SmallSNOSPDKernel::computePDNonlocalOffDiagJacobian(unsigned int jvar_num,
